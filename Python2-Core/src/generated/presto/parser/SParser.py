...
class SParser ( AbstractParser ):
    ...
    class Category_method_declaration_listContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(SParser.Category_method_declaration_listContext, self).__init__(parent, invokingState)
            self.parser = parser
        ...
        def copyFrom(self, ctx):
            super(SParser.Category_method_declaration_listContext, self).copyFrom(ctx)


    class CategoryMethodListContext(Category_method_declaration_listContext):

        def __init__(self, parser, ctx): # actually a SParser.Category_method_declaration_listContext)
    ...
    class Category_method_declarationContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(SParser.Category_method_declarationContext, self).__init__(parent, invokingState)
            self.parser = parser
        ...
        def copyFrom(self, ctx):
            super(SParser.Category_method_declarationContext, self).copyFrom(ctx)



    class GetterMethodContext(Category_method_declarationContext):

        def __init__(self, parser, ctx): # actually a SParser.Category_method_declarationContext)
            super(SParser.GetterMethodContext, self).__init__(parser)
    ...
    class MemberMethodContext(Category_method_declarationContext):
        ...
        def __init__(self, parser, ctx): # actually a SParser.Category_method_declarationContext)
            super(SParser.MemberMethodContext, self).__init__(parser)
    ...
    class SetterMethodContext(Category_method_declarationContext):
        ...
        def __init__(self, parser, ctx): # actually a SParser.Category_method_declarationContext)
            super(SParser.SetterMethodContext, self).__init__(parser)
    ...
    class OperatorMethodContext(Category_method_declarationContext):
        ...
        def __init__(self, parser, ctx): # actually a SParser.Category_method_declarationContext)
            super(SParser.OperatorMethodContext, self).__init__(parser)
