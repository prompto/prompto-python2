...
class SParser ( AbstractParser ):
    ...
    class Read_all_expressionContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(SParser.Read_all_expressionContext, self).__init__(parent, invokingState)
            self.parser = parser
            self.source = None # ExpressionContext
    ...
    class Read_one_expressionContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(SParser.Read_one_expressionContext, self).__init__(parent, invokingState)
            self.parser = parser
            self.source = None # ExpressionContext
