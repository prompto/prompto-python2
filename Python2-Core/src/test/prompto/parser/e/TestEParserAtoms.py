...
class TestParserAtoms(unittest.TestCase):
    ...
    def testTuple(self):
        ...
        literal = self.parse(statement,ECleverParser.tuple_literal)
        self.assertIsNotNone(literal)
        self.assertEquals("1",str(literal.expressions[0]))
        self.assertEquals("\"John\"",str(literal.expressions[1]))
        self.assertEquals("'12:12:12'",str(literal.expressions[2]))
        self.assertEquals("(1, \"John\", '12:12:12')", str(literal))
