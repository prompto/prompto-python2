...
class ConcreteInstance(BaseValue, IInstance, IMultiplyable):
    ...
    def getMemberValue(self, context, attrName, autoCreate=False):
        if "category" == attrName:
            ...
            return super(ConcreteInstance, self).getMemberValue(context, attrName, autoCreate)
        else:
    ...
    def Multiply(self, context, value):
        try:
            ...
            return super(ConcreteInstance, self).Multiply(context, value)
    ...
    def Divide(self, context, value):
        try:
            ...
            return super(ConcreteInstance, self).Divide(context, value)
    ...
    def IntDivide(self, context, value):
        try:
            ...
            return super(ConcreteInstance, self).IntDivide(context, value)
    ...
    def Modulo(self, context, value):
        try:
            ...
            return super(ConcreteInstance, self).Modulo(context, value)
    ...
    def Add(self, context, value):
        try:
            ...
            return super(ConcreteInstance, self).Add(context, value)
    ...
    def Subtract(self, context, value):
        try:
            ...
            return super(ConcreteInstance, self).Subtract(context, value)
